...
class NewProductImage extends StatelessWidget {
  final title;
  final price;
  final image;
  final product;
  final bool newBool;
  final bool actionBool;
  const NewProductImage(
      ...
      required this.newBool,
      required this.actionBool,});
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: Container(
                          ...
                          child: Text('new', style: TextStyle(color: Color(0xFF6E62F9), fontWeight: FontWeight.bold),),
                        ),
                      )
                    ],
                  ),
